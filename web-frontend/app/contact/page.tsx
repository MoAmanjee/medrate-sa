      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-2">support@ratethedoctor.co.za</p>
            <p className="text-gray-600">info@ratethedoctor.co.za</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-2">+27 11 234 5678</p>
            <p className="text-gray-600 text-sm">Mon-Fri: 9AM - 5PM SAST</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600">2196, South Africa</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600 text-sm">We aim to respond to all inquiries promptly</p>
          </div>
        </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-xl font-bold hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 disabled:opacity-50"
              >

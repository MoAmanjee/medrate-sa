...
export default function HospitalsPage() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const mockHospitals = [
        {
          ...
          verified: true,
          promoted: true,
          specialties: ["Emergency", "Cardiology", "Maternity", "Surgery"],
          phone: "+27112345678",
          distance: "3.2 km",
        },
        {
      ...
      if (filters.city) {
        filtered = filtered.filter(h => h.city.includes(filters.city));
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4">Find Hospitals & Clinics</h1>
          <p className="text-xl text-gray-600">Search for verified hospitals and medical facilities in South Africa</p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 bg-white rounded-2xl shadow-lg p-3 border-2 border-gray-200 focus-within:border-blue-500 transition-all">
            ...
            <input
              ...
              placeholder="Search for a hospital, clinic, or specialty..."
          ...
          <div className="flex-1">
            {loading ? (
              ...
              <div className="text-center py-20 bg-white rounded-2xl shadow-lg">
                ...
                <p className="text-gray-600 font-semibold text-lg mb-2">No hospitals found</p>
              ...
              <div className="space-y-4">
                <div className="mb-4">
                  <p className="text-gray-600 font-medium">
                    Found <span className="font-bold text-gray-900">{hospitals.length}</span> hospital{hospitals.length !== 1 ? 's' : ''}
                  </p>
                </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          {hospital.verified && (
                            <svg className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" title="Verified Hospital">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <Link
                            ...
                            className="ml-auto px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 rounded-xl transition-all font-bold shadow-lg hover:shadow-xl transform hover:scale-105"
                          >
                            View Profile →
                          </Link>
                        </div>
